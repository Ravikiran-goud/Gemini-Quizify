...
class ChromaCollectionCreator:
    ...
    def create_chroma_collection(self):
        ...
        for page in self.processor.pages:
            chunks = text_splitter.split_text(page.page_content)  # Use the correct attribute
    ...
    def as_retriever(self):
        """
        Returns the retriever from the Chroma collection.
        """
        if not self.db:
